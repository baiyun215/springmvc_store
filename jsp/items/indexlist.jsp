...
================================================== -->
	            ...
	            <span class="icon-bar"></span>
						...
						<div id="navbar" class="collapse navbar-collapse">
							<ul class="nav navbar-nav">
								...
								<li>
									<a href="${pageContext.request.contextPath }/cart/queryCart.action?userId=${user.id}">购物车</a>
								</li>
								<li>
									<a href="buy.html">我的订单</a>
								</li>
								<li>
    ...
    ================================================== -->
		...
		function addCart(item_id){
				...
				window.location.href="${pageContext.request.contextPath }/cart/addCart.action?userId=${user.id}&itemId="+item_id+"&num="+num;
			}
		</script>
	</body>
